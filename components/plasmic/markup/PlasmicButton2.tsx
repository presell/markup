...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: E9kwS2vogbuDx/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: ylA5Nn0v12MEsB/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__qRae6)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__dmsTh)}
                role={"img"}
              />
            ),
